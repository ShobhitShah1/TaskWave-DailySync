...
- When making database changes, ensure proper migration scripts are included.
- Test notification functionality on both iOS and Android before submitting PRs.
